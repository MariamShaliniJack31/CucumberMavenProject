...
public class GoogleHomePageFactory extends DriverScript {
	...
	@FindBy(xpath = "//div[@class='FPdoLc lJ9FBc']//input[@name='btnI' and @type='submit']")
	public WebElement ImFeelingLuckyButton;
	
	public GoogleHomePageFactory() {
		
		PageFactory.initElements(driver, this);
		System.out.println("I AM IN PAGEFACTORY INITELEMENTS");
	}
	
	public void SearchTextBoxDisplay() {

		System.out.println("I AM IN TEXTBOX" + SearchTextBox.isDisplayed());
		Helper.highLighterMethod(driver,SearchTextBox) ;
		SearchTextBox.clear();

		System.out.println("Search Text Box Present is : " + SearchTextBox.isDisplayed() );
...
//		 }
	...
	public void ImFeelingLuckyButtonDisplay() {
		if ( ImFeelingLuckyButton.isDisplayed() )  {
